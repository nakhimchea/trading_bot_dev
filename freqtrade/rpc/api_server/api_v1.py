...
from freqtrade.rpc.api_server.api_schemas import (AvailablePairs, Balances, BlacklistPayload,
                                                  ...
                                                  Version, WhitelistResponse, ConfigPayload)
...
@router_public.post('/change_config', tags=['pairlist'])
def configfile_post(payload: ConfigPayload, rpc: RPC = Depends(get_rpc)):
    return rpc._rpc_change_config(payload)


@router_public.post('/newfile', tags=['pairlist'])
def configfile_post(payload: ConfigPayload, rpc: RPC = Depends(get_rpc)):
    return rpc._rpc_newfile(payload)
